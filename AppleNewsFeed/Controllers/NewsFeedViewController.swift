...
//  AppleNewsFeed
//
//  Created by baiba.vaisle on 15/08/2021.
//
...
class NewsFeedViewController: UIViewController {
    ...
    func handleGetData(){
            self.activityIndicator(animated: true)
            let jsonUrl = "https://newsapi.org/v2/everything?q=apple&from=2021-08-01&to=2021-08-16&sortBy=popularity&apiKey=5e39034a500c4ca8b3549c11f7fba665"
